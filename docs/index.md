...
=== "CONTENU DE SÉANCE"
    ...
    - Organiser [un classeur numérique pour la NSI sur GitHub](./github) -> ==**Reprendre** en main l'environnement web de Visual Studio Code depuis votre iPad et depuis un des PC du labo de SI pour gérer vos fichiers== ;
